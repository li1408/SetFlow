...
export const TricepsGroup = ({
  ...
  return (
    <g className="muscle-map__group" onClick={() => onToggleMuscle(OriginalMuscle.TRICEPS)}>
      <path
        className={getMuscleClasses(OriginalMuscle.TRICEPS)}
        d="M 478.44,132.70
        ...
        data-elem={OriginalMuscle.TRICEPS}
        fill="#757575"
        id="path78"
        stroke="black"
        strokeWidth="0"
