...
export const ShouldersGroup = ({
  ...
  return (
    <g className="muscle-map__group" onClick={() => onToggleMuscle(OriginalMuscle.SHOULDERS)}>
      <path
        className={getMuscleClasses(OriginalMuscle.SHOULDERS)}
        d="M 349.30,110.19
        ...
        data-elem={OriginalMuscle.SHOULDERS}
        id="path96"
        stroke="black"
        strokeWidth="0"
      />
