...
export const TrapsGroup = ({
  ...
  return (
    <g className="muscle-map__group" onClick={() => onToggleMuscle(OriginalMuscle.TRAPS)}>
      <path
        ...
        data-elem={OriginalMuscle.TRAPS}
        stroke="black"
        strokeWidth="0"
      />

      <path
        className={getMuscleClasses(OriginalMuscle.TRAPS)}
        d="M 424.86,75.58
