...
export const ChestGroup = ({
  ...
  return (
    <g className="muscle-map__group" onClick={() => onToggleMuscle(OriginalMuscle.CHEST)}>
      <path
        ...
        data-elem={OriginalMuscle.CHEST}
        stroke="black"
        strokeWidth="0"
      />

      <path
        className={getMuscleClasses(OriginalMuscle.CHEST)}
        d="M 128.00,122.83
