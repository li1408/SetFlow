import { OriginalMuscle, type OriginalMuscleId } from "../original-muscle-options";

export const AbdominalsGroup = ({
  onToggleMuscle,
  getMuscleClasses,
}: {
  onToggleMuscle: (muscle: OriginalMuscleId) => void;
  getMuscleClasses: (muscle: OriginalMuscleId) => string;
}) => {
  return (
    <g className="muscle-map__group" onClick={() => onToggleMuscle(OriginalMuscle.ABDOMINALS)}>
      <path
        className="muscle-map__hit-area"
        d="M 100.75,123.75
        ...
        data-elem={OriginalMuscle.ABDOMINALS}
        stroke="black"
        strokeWidth="0"
      />
      ...
      {/* Path 108 */}
      <path
        className={getMuscleClasses(OriginalMuscle.ABDOMINALS)}
        d="M 124.01,216.93
