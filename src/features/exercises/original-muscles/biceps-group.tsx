...
export const BicepsGroup = ({
  ...
  return (
    <g className="muscle-map__group" onClick={() => onToggleMuscle(OriginalMuscle.BICEPS)}>
      <path
        ...
        data-elem={OriginalMuscle.BICEPS}
        stroke="black"
        strokeWidth="0"
      />
      <path
        className={getMuscleClasses(OriginalMuscle.BICEPS)}
        d="M 166.82,151.36
