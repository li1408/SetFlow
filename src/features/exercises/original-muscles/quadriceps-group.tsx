...
export const QuadricepsGroup = ({
  ...
  return (
    <g className="muscle-map__group" onClick={() => onToggleMuscle(OriginalMuscle.QUADRICEPS)}>
      <path
        ...
        data-elem={OriginalMuscle.QUADRICEPS}
        stroke="black"
        strokeWidth="0"
      />
      <path
        className={getMuscleClasses(OriginalMuscle.QUADRICEPS)}
        d="M 98.39,269.85
