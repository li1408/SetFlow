...
export const ObliquesGroup = ({
  ...
  return (
    <g className="muscle-map__group" onClick={() => onToggleMuscle(OriginalMuscle.OBLIQUES)}>
      <path
        className={getMuscleClasses(OriginalMuscle.OBLIQUES)}
        d="M 134.28,178.67
        ...
        data-elem={OriginalMuscle.OBLIQUES}
        id="path128"
        stroke="black"
        strokeWidth="0"
      />
