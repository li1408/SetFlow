...
export const GlutesGroup = ({
  ...
  return (
    <g className="muscle-map__group" onClick={() => onToggleMuscle(OriginalMuscle.GLUTES)}>
      <path
        ...
        data-elem={OriginalMuscle.GLUTES}
        stroke="black"
        strokeWidth="0"
      />

      <path
        className={getMuscleClasses(OriginalMuscle.GLUTES)}
        d="M 424.40,232.59
