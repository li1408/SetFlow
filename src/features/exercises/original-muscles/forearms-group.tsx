...
export const ForearmsGroup = ({
  ...
  return (
    <g className="muscle-map__group" onClick={() => onToggleMuscle(OriginalMuscle.FOREARMS)}>
      <path
        className={getMuscleClasses(OriginalMuscle.FOREARMS)}
        d="M 355.58,156.70
        ...
        data-elem={OriginalMuscle.FOREARMS}
        id="path94"
        stroke="black"
        strokeWidth="0"
      />
